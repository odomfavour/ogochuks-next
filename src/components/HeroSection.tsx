        ...
        <div className="flex flex-col-reverse lg:flex-row min-h-screen">
          <div className="lg:w-3/5 w-full flex items-center">
            <div className="mb-3">
              ...
              <h2 className="lg:text-7xl text-5xl font-bold mb-4">Ogochukwu Odom</h2>
          ...
          <div className="lg:w-2/5 w-full flex justify-end flex-col">
            <Image src={ogo} alt="ogochuks profile pic" className="w-full mt-20 lg:mt-0" />
          </div>
        </div>
      </div>
    </section>
