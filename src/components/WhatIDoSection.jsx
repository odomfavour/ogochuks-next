            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
              <div>
                <div className="p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 cursor-pointer h-full">
                  ...
                  <p className="md:text-2xl text-xl font-bold">Web Development</p>
                  <p>
              ...
              <div>
                <div className="p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 cursor-pointer h-full">
                  ...
                  <p className="md:text-2xl text-xl font-bold">Training & Mentorship</p>
                  <p>
              ...
              <div>
                <div className="p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 cursor-pointer h-full">
                  ...
                  <p className="md:text-2xl text-xl font-bold">Web Consulting</p>
                  <p>
